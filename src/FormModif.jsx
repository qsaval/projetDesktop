...
export function FormModif(){
    ...
    const {loading, data, error} = useFetch('http://127.0.0.1:8000/lire1bd.php?id=' + id)
    ...
    return (
        <div className="container">
            ...
            {data && <form onSubmit={handleSubmit} method="post">
                ...
                <Input label="image" name="image"  type="text" value={data.image}/>
                ...
                <Select lebel="fourniseur" name="fournisseur" value={data.fournisseur_id} nom={data.nom_fourniseur}/>
